...
export const login = async (req, res) => {
  try {
    ...
    // Get complete user data with all necessary fields
    ...
    const responseData = {
      ...
      verifyOtpExpiryAt: userData.verifyOtpExpiryAt,
      resetOtp: userData.resetOtp,
      resetOtpExpiryAt: userData.resetOtpExpiryAt,
...
export const isAuthenticated = async (req, res) => {
  try {
    // Find user and explicitly select all fields we need
    const user = await User.findById(req.user.id).select('+isVerified +verifyOtp +verifyOtpExpiryAt +resetOtp +resetOtpExpiryAt +createdAt +updatedAt');
